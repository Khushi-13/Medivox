...
logo_b64 = encode_logo("/Users/khushidubal/Downloads/NeuroMedAI/icons/Logo.png")
...
def process_inputs(history, user_text=None, audio_file=None, image_file=None):
    ...
    if not chat_history:
        chat_history.append({"role": "assistant", "content": "Hi, I’m MediVox — your AI medical assistant. How can I help you today?"})
    ...
    gr.HTML(f"""
        <div class="header-logo" style="display: flex; align-items: center;">
            <div class="logo-image-wrapper">
                <img src='data:image/png;base64,{logo_b64}' alt='Medivox Logo' class='logo-img'>
            </div>
            <div class="logo-text" style="display: inline-block; vertical-align: middle;">MEDIVOX</div>
        </div>
    """, elem_classes="header")

    with gr.Column(elem_id="chat-container"):
        chatbot = gr.Chatbot(elem_id="chatbot", show_label=False, elem_classes="chatbot-container", type="messages", value=[{"role": "assistant", "content": "Hi, I’m MediVox — your AI medical assistant. How can I help you today?"}], height=500)
